$(document).ready(function() {
    ...
    $( "[href='/administrator/cooperation/activities/new/']" ).parent().addClass('active').parent().addClass('open');
    $( "[href='/administrator/cooperation/activities/new/']" ).parent().parent().parent().addClass('active open hsub');
    $( "[href='/administrator/cooperation/activities/new/']" ).parent().parent().parent().parent().parent().addClass('active open hsub');
    ...
    $(document).on( 'submit' , "form[name='form-new-project']" ,function () {
        if( validateblank() ) {
            ...
            $.ajax({
                url : '/administrator/cooperation/activities/add/',
                type : 'post',
                data : formData,
                async : true,
                contentType: false,
