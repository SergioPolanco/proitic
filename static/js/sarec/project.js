$(document).ready(function() {
    ...
    $( "[href='/administrator/cooperation/projects/new/']" ).parent().addClass('active').parent().addClass('open');
    $( "[href='/administrator/cooperation/projects/new/']" ).parent().parent().parent().addClass('active open hsub');
    $( "[href='/administrator/cooperation/projects/new/']" ).parent().parent().parent().parent().parent().addClass('active open hsub');
    ...
    $(document).on( 'submit' , "form[name='form-new-project']" ,function () {
        if( validateblank() ) {
            ...
            $.ajax({
                url : '/administrator/cooperation/projects/add/',
                type : 'post',
                data : formData,
                async : true,
                contentType: false,
