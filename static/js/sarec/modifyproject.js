$(document).ready(function() {
    ...
    $( "[href='/administrator/cooperation/projects/modify/']" ).parent().addClass('active').parent().addClass('open');
    $( "[href='/administrator/cooperation/projects/modify/']" ).parent().parent().parent().addClass('active open hsub');
    $( "[href='/administrator/cooperation/projects/modify/']" ).parent().parent().parent().parent().parent().addClass('active open hsub');
    ...
    $( document ).on( 'click', 'i.fa-pencil.bigger-130', function(e) {
        $.ajax({
            url : '/administrator/cooperation/projects/search/',
            type : 'post',
            ...
            success: function(data) {
                if( data.status === 'False' ) {
                  ...
                  $( 'input[name="projectname"]' ).val( data.name );
    ...
    $(document).on( 'submit' , "form[name='form-new-project']" ,function () {
        ...
        if( validateblank() ) {
            ...
            $.ajax({
                url : '/administrator/cooperation/projects/update/',
                type : 'post',
                data : formData,
                async : true,
                contentType: false,
...
function validateblank() {
    var validate = false;
    $(" #trumbowyg-demo, input[name='projectname'] ").each(function(){
        if( $( this ).val() === '' ) {
            validate = true;
            $( this ).parent().parent().addClass('has-error');
        }
