$(document).ready(function() {
    ...
    $( "[href='/administrator/cooperation/institution/new/']" ).parent().addClass('active').parent().addClass('open');
    $( "[href='/administrator/cooperation/institution/new/']" ).parent().parent().parent().addClass('active open hsub');
    $( "[href='/administrator/cooperation/institution/new/']" ).parent().parent().parent().parent().parent().addClass('active open hsub');
    ...
    $(document).on( 'submit' , "form[name='form-new-project']" ,function () {
        if( validateblank() ) {
            ...
            $.ajax({
                url : '/administrator/cooperation/institution/add/',
                type : 'post',
                data : formData,
                async : true,
                contentType: false,
